...
export default function ExpandableCard({ cards }: { cards: Array<any> }) {
                            ...
                            <div>
                                <div className="flex items-start justify-between p-4">
                                    ...
                                    <motion.a
                                        ...
                                        href={active.ctaLink || null}
                                        target="_blank"
                                        className="cursor-pointer rounded-full bg-green-500 px-4 py-3 text-sm font-bold text-white hover:bg-green-700"
                                        onClick={() => setActive(null)}
                                    >
                                        Close
                                    </motion.a>
